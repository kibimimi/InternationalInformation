...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'craue.form.flow.step_field_extension' => 'getCraue_Form_Flow_StepFieldExtensionService',
    ...
    /**
     * Gets the 'craue.form.flow.step_field_extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Craue\FormFlowBundle\Form\Extension\FormFlowStepFieldExtension A Craue\FormFlowBundle\Form\Extension\FormFlowStepFieldExtension instance
     */
    protected function getCraue_Form_Flow_StepFieldExtensionService()
    {
        return $this->services['craue.form.flow.step_field_extension'] = new \Craue\FormFlowBundle\Form\Extension\FormFlowStepFieldExtension();
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'createthemespresta', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'\\src\\MyformsBundle\\Resources\\config\\doctrine') => 'MyformsBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'MyformsBundle\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('MyformsBundle' => 'MyformsBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_5ef61b38a787549f00903a86e258c16104bd8e4b4499c6c3379f9cefa277c5aa');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\MyformsBundle/Resources/views'), 'Myforms');
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('57f66ad23d7d90.63906681')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'MyformsBundle' => 'MyformsBundle\\MyformsBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'createthemespresta',
            'database_user' => 'root',
